...
| `compress-captures.ps1` · `claudish-watchdog.ps1` | nightly 7z compaction + GDrive backup (02:47 — moved off 04:17 on 2026-08-20: the 60-70 min run collided with the 04:00 container restart) · health check, proactive restart, hang recovery — **written for a 15-min schedule that has never been armed on any machine** (verified 2026-08-23: no `Get-ScheduledTask` entry, 4 log lines from 31 May) |
